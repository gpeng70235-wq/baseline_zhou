...
assert(nnz(steady)>10,'ZhouIter11Ref:InvalidSteadyWindow','Steady window is too short.');
...
[summary.phase_current_thd_cycle_boundary_percent,~]=zhou_iter11_ref.metrics.phase_thd( ...
...
[summary.phase_current_thd_40_harmonic_percent,~]=zhou_iter11_ref.metrics.phase_thd( ...
...
[summary.phase_current_thd_percent, ...
    ...
    summary.phase_current_distortion_rms_A]=zhou_iter11_ref.metrics.phase_thd_total_rms( ...
    wave.ia_A(steady_wave),wave.time_s(steady_wave), ...
