...
[origin_inside, origin_residual] = ...
    zhou_ipmsm.geometry.point_in_rectangle([0, 0], rect, tolerance);
first_intersection = zhou_ipmsm.geometry.line_rectangle_intersections( ...
    rect, 1, tolerance);
...
for line_id = 2:3
    intersections(line_id) = ...
        zhou_ipmsm.geometry.line_rectangle_intersections(rect, line_id, tolerance);
