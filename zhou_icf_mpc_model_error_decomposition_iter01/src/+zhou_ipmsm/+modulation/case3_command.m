...
[sector, boundary] = zhou_ipmsm.geometry.sector_of_point(reference_ab, sector_tolerance);
assert(sector >= 1 && sector <= 6, 'ZhouIPMSM:Case3ZeroReference', ...
...
command.positive_duration_switching_actions = ...
    zhou_ipmsm.inverter.count_sequence_transitions(states(durations > 0, :));
