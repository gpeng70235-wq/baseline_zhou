...
assert(nnz(steady)>10,'Zhou:InvalidSteadyWindow','Steady window is too short.');
...
[summary.phase_current_thd_cycle_boundary_percent,~]=zhou.metrics.phase_thd( ...
...
[summary.phase_current_thd_40_harmonic_percent,~]=zhou.metrics.phase_thd( ...
...
[summary.phase_current_thd_percent, ...
    ...
    summary.phase_current_distortion_rms_A]=zhou.metrics.phase_thd_total_rms( ...
    wave.ia_A(steady_wave),wave.time_s(steady_wave), ...
