...
for segment = 1:numel(ids)
    ...
    applied_average_dq = applied_average_dq + ...
        dt/Ts * zhou.math.park(voltage_ab, theta_mid);

    k1 = zhou.model.pmsm_derivative(next_state,voltage_ab,omega_e,motor,delta_voltage_ab);
    k2 = zhou.model.pmsm_derivative(next_state+dt*k1/2,voltage_ab,omega_e,motor,delta_voltage_ab);
    k3 = zhou.model.pmsm_derivative(next_state+dt*k2/2,voltage_ab,omega_e,motor,delta_voltage_ab);
    k4 = zhou.model.pmsm_derivative(next_state+dt*k3,voltage_ab,omega_e,motor,delta_voltage_ab);
